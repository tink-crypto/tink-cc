...
#ifndef TINK_SIGNATURE_SUBTLE_CREATE_ECDSA_KEY_H_
#define TINK_SIGNATURE_SUBTLE_CREATE_ECDSA_KEY_H_
...
// Generates a new standalone EcdsaPrivateKey from parameters.
...
#endif  // TINK_SIGNATURE_SUBTLE_CREATE_ECDSA_KEY_H_
