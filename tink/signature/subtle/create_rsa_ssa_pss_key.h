...
#ifndef TINK_SIGNATURE_SUBTLE_CREATE_RSA_SSA_PSS_KEY_H_
#define TINK_SIGNATURE_SUBTLE_CREATE_RSA_SSA_PSS_KEY_H_
...
// Generates a new standalone RsaSsaPssPrivateKey from parameters.
// Most users should not call this API directly. Instead, most users should
// utilize keysets to ensure key rotation.
absl::StatusOr<RsaSsaPssPrivateKey> CreateRsaSsaPssPrivateKey(
...
#endif  // TINK_SIGNATURE_SUBTLE_CREATE_RSA_SSA_PSS_KEY_H_
