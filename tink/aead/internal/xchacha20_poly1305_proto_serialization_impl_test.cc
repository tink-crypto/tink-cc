...
using XChaCha20Poly1305ProtoSerializationTest = TestWithParam<TestCase>;
...
TEST_F(XChaCha20Poly1305ProtoSerializationTest,
  ...
  ASSERT_THAT(
      RegisterXChaCha20Poly1305ProtoSerializationWithRegistryBuilder(builder),
      IsOk());
  ASSERT_THAT(
      RegisterXChaCha20Poly1305ProtoSerializationWithRegistryBuilder(builder),
      IsOk());
...
TEST_P(XChaCha20Poly1305ProtoSerializationTest, ParseKeyWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(
      RegisterXChaCha20Poly1305ProtoSerializationWithMutableRegistry(registry),
...
TEST_P(XChaCha20Poly1305ProtoSerializationTest, ParseKeyWithImmutableRegistry) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(
      RegisterXChaCha20Poly1305ProtoSerializationWithRegistryBuilder(builder),
