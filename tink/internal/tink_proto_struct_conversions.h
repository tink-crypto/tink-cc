...
#ifndef TINK_INTERNAL_TINK_PROTO_STRUCT_CONVERSIONS_H_
#define TINK_INTERNAL_TINK_PROTO_STRUCT_CONVERSIONS_H_
...
#endif  // TINK_INTERNAL_TINK_PROTO_STRUCT_CONVERSIONS_H_
