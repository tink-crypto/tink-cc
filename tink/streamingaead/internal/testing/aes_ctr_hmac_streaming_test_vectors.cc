...
const StreamingAeadTestVector& CreateAesCtrHmacStreamingSha1Sha256TestVector() {
  static const absl::NoDestructor<StreamingAeadTestVector> test_vector([]() {
    ...
    std::string c1 =
        Xor(msg1, HexDecodeOrDie("2999c8ea5401704243c8cd77929fd52617fec5542a842"
                                 "446251bb2f3a81f6249"));
    std::string c2 = Xor(
    ...
    return StreamingAeadTestVector(
        std::make_shared<AesCtrHmacStreamingKey>(*key), plaintext,
...
// Created in Java.
const StreamingAeadTestVector&
CreateAesCtrHmacStreamingSha1Sha256EmptyPtTestVector() {
  static const absl::NoDestructor<StreamingAeadTestVector> test_vector([]() {
    absl::StatusOr<AesCtrHmacStreamingParameters> parameters =
        AesCtrHmacStreamingParameters::Builder()
            .SetKeySizeInBytes(16)
    ...
    std::string ciphertext = HexDecodeOrDie(
        "1874eaeea1260b1cf44d00bfec6d7f58878ce2dd70d5844e2f4410a04703ec4c17ca8c"
        "88"
...
const StreamingAeadTestVector&
CreateAesCtrHmacStreamingSha256Sha512TestVector() {
  static const absl::NoDestructor<StreamingAeadTestVector> test_vector([]() {
    absl::StatusOr<AesCtrHmacStreamingParameters> parameters =
        AesCtrHmacStreamingParameters::Builder()
            .SetKeySizeInBytes(16)
    ...
    std::string ciphertext = HexDecodeOrDie(
        "18ae4fc7af4ed0433d33110793196ead8a77d2ae3f42db8425dc9e0789bdba7d5c23d6"
        "12"
...
const StreamingAeadTestVector& CreateAesCtrHmacStreamingSha512Sha1TestVector() {
  static const absl::NoDestructor<StreamingAeadTestVector> test_vector([]() {
    absl::StatusOr<AesCtrHmacStreamingParameters> parameters =
        AesCtrHmacStreamingParameters::Builder()
            .SetKeySizeInBytes(16)
    ...
    std::string associated_data = HexDecodeOrDie("000102030405");
    std::string ciphertext = HexDecodeOrDie(
        "180d87a22c8979d8eb90163aa33aa09a02bab964d5bb2d7a035e62206d62807b3e9bb4"
        "98"
        "4109ebeb3dfcbf43");
    return StreamingAeadTestVector(
        std::make_shared<AesCtrHmacStreamingKey>(*key), plaintext,
...
const StreamingAeadTestVector&
CreateAesCtrHmacStreamingKey32Sha512Sha512TestVector() {
  static const absl::NoDestructor<StreamingAeadTestVector> test_vector([]() {
    absl::StatusOr<AesCtrHmacStreamingParameters> parameters =
        AesCtrHmacStreamingParameters::Builder()
    ...
    std::string ciphertext = HexDecodeOrDie(
        "18290c66c47a6095d947aa1671bd7b6d9c306e24d51d4b8a4f1b9db123a01226ebd2b6"
        "f7"
        "e05298a9f5908072");
    return StreamingAeadTestVector(
        std::make_shared<AesCtrHmacStreamingKey>(*key), plaintext,
...
const StreamingAeadTestVector&
CreateAesCtrHmacStreamingKey32Derived32TestVector() {
  static const absl::NoDestructor<StreamingAeadTestVector> test_vector([]() {
    absl::StatusOr<AesCtrHmacStreamingParameters> parameters =
        AesCtrHmacStreamingParameters::Builder()
            .SetKeySizeInBytes(32)
    ...
    std::string associated_data =
        HexDecodeOrDie("012345678901234567890123456789");
    std::string ciphertext = HexDecodeOrDie(
        "28f7bcc58e83e8e24bf833d8586c889ef465f52fdebcad6deb18be062c180e466de959"
        "eb"
...
CreateAesCtrHmacStreamingTestVectors() {
  static const absl::NoDestructor<std::vector<StreamingAeadTestVector>>
      test_vectors([]() {
        return std::vector<StreamingAeadTestVector>{
            CreateAesCtrHmacStreamingSha1Sha256TestVector(),
            CreateAesCtrHmacStreamingSha1Sha256EmptyPtTestVector(),
            CreateAesCtrHmacStreamingSha256Sha512TestVector(),
            CreateAesCtrHmacStreamingSha512Sha1TestVector(),
            CreateAesCtrHmacStreamingKey32Sha512Sha512TestVector(),
            CreateAesCtrHmacStreamingKey32Derived32TestVector(),
        };
      }());
...
const StreamingAeadTestVector& GetAesCtrHmacStreamingTestVector(
  ...
  static const absl::NoDestructor<
      absl::flat_hash_map<int, const StreamingAeadTestVector*>>
      vectors([]() {
        return absl::flat_hash_map<int, const StreamingAeadTestVector*>{
            {16, &CreateAesCtrHmacStreamingSha1Sha256TestVector()},
            {32, &CreateAesCtrHmacStreamingKey32Derived32TestVector()},
        };
      }());
  auto it = vectors->find(key_size_in_bytes);
  ABSL_CHECK(it != vectors->end())
      << "No AES-CTR-HMAC streaming test vector found for key size: "
      << key_size_in_bytes;
  return *it->second;
}
