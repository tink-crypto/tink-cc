...
#ifndef TINK_SIGNATURE_SUBTLE_CREATE_SLH_DSA_KEY_H_
#define TINK_SIGNATURE_SUBTLE_CREATE_SLH_DSA_KEY_H_
...
// Generates a new standalone SlhDsaPrivateKey from parameters.
...
#endif  // TINK_SIGNATURE_SUBTLE_CREATE_SLH_DSA_KEY_H_
