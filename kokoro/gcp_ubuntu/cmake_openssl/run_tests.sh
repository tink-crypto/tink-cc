...
echo "==========================================================================="
echo "Tink Script ID: 689d425c508f9c1c066e (to quickly find the script from logs)"
echo "==========================================================================="
...
if [[ -n "${KOKORO_ARTIFACTS_DIR:-}" ]]; then
  ...
  source kokoro/testutils/ccache_enable.sh "${TINK_CC_CMAKE_AND_OPENSSL_1_1_1_IMAGE_HASH}"
...
# 2. Runs the main Tink C++ CMake tests with system OpenSSL.
# 3. Runs the examples CMake tests with system OpenSSL.
