...
#ifndef TINK_AEAD_AES_EAX_KEY_H_
...
// Represents an AEAD that uses AES-EAX.
class AesEaxKey final : public AeadKey {
 public:
  // Copyable and movable.
  AesEaxKey(const AesEaxKey& other) = default;
  AesEaxKey& operator=(const AesEaxKey& other) = default;
  AesEaxKey(AesEaxKey&& other) = default;
  AesEaxKey& operator=(AesEaxKey&& other) = default;
  ...
  const AesEaxParameters& GetParameters() const override { return parameters_; }
...
#endif  // TINK_AEAD_AES_EAX_KEY_H_
