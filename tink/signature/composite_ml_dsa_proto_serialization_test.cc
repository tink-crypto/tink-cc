...
class CompositeMlDsaProtoSerializationTest : public TestWithParam<TestCase> {
 protected:
...
KeyData::KeyMaterialType ToProtoKeyMaterialType(
  ...
  switch (key_material_type) {
    case google::crypto::tink::internal::KeyDataTP::KeyMaterialTypeTP::
        kSymmetric:
    ...
    case google::crypto::tink::internal::KeyDataTP::KeyMaterialTypeTP::kRemote:
...
TEST_F(CompositeMlDsaProtoSerializationTest, RegisterTwiceSucceeds) {
  ASSERT_THAT(RegisterCompositeMlDsaProtoSerialization(), IsOk());
  ASSERT_THAT(RegisterCompositeMlDsaProtoSerialization(), IsOk());
}

TEST_P(CompositeMlDsaProtoSerializationTest, ParseParametersWorks) {
...
TEST_P(CompositeMlDsaProtoSerializationTest, SerializeParametersWorks) {
  TestCase test_case = GetParam();
  ASSERT_THAT(RegisterCompositeMlDsaProtoSerialization(), IsOk());
...
TEST_P(CompositeMlDsaProtoSerializationTest, ParsePublicKeyWorks) {
  TestCase test_case = GetParam();
  ASSERT_THAT(RegisterCompositeMlDsaProtoSerialization(), IsOk());
...
TEST_F(CompositeMlDsaProtoSerializationTest,
  ...
  absl::StatusOr<std::unique_ptr<Serialization>> serialization =
      internal::MutableSerializationRegistry::GlobalInstance()
          .SerializeKey<ProtoKeySerialization>(private_key.GetPublicKey(),
                                               /*token=*/std::nullopt);
  ASSERT_THAT(serialization, IsOk());
...
TEST_P(CompositeMlDsaProtoSerializationTest, SerializePublicKeyWorks) {
  TestCase test_case = GetParam();
  ASSERT_THAT(RegisterCompositeMlDsaProtoSerialization(), IsOk());
  ...
  absl::StatusOr<std::unique_ptr<Serialization>> serialization =
      internal::MutableSerializationRegistry::GlobalInstance()
          .SerializeKey<ProtoKeySerialization>(*public_key,
                                               /*token=*/std::nullopt);
  ASSERT_THAT(serialization, IsOk());
...
TEST_P(CompositeMlDsaProtoSerializationTest, ParsePrivateKeyWorks) {
  TestCase test_case = GetParam();
  ASSERT_THAT(RegisterCompositeMlDsaProtoSerialization(), IsOk());
...
TEST_F(CompositeMlDsaProtoSerializationTest,
  ...
  absl::StatusOr<std::unique_ptr<Serialization>> serialization =
      internal::MutableSerializationRegistry::GlobalInstance()
          .SerializeKey<ProtoKeySerialization>(private_key,
                                               InsecureSecretKeyAccess::Get());
  ASSERT_THAT(serialization, IsOk());
...
TEST_P(CompositeMlDsaProtoSerializationTest, SerializePrivateKeyWorks) {
  TestCase test_case = GetParam();
  ASSERT_THAT(RegisterCompositeMlDsaProtoSerialization(), IsOk());
