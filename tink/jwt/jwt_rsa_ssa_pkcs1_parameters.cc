...
JwtRsaSsaPkcs1Parameters::Builder::SetAlgorithm(Algorithm algorithm) {
  algorithm_ = algorithm;
  return *this;
}

JwtRsaSsaPkcs1Parameters::Builder&
JwtRsaSsaPkcs1Parameters::Builder::SetKidStrategy(KidStrategy kid_strategy) {
  kid_strategy_ = kid_strategy;
  return *this;
}

JwtRsaSsaPkcs1Parameters::Builder&
JwtRsaSsaPkcs1Parameters::Builder::SetModulusSizeInBits(
...
JwtRsaSsaPkcs1Parameters::Builder&
JwtRsaSsaPkcs1Parameters::Builder::SetPublicExponent(
    const BigInteger& public_exponent) {
  public_exponent_ = public_exponent;
  return *this;
}

util::StatusOr<JwtRsaSsaPkcs1Parameters>
JwtRsaSsaPkcs1Parameters::Builder::Build() {
  ...
  return JwtRsaSsaPkcs1Parameters(*algorithm_, *kid_strategy_,
                                  *modulus_size_in_bits_, public_exponent_);
}

bool JwtRsaSsaPkcs1Parameters::operator==(const Parameters& other) const {
  const JwtRsaSsaPkcs1Parameters* that =
      dynamic_cast<const JwtRsaSsaPkcs1Parameters*>(&other);
  if (that == nullptr) {
    return false;
  }
...
// public exponent.
BigInteger JwtRsaSsaPkcs1Parameters::Builder::CreateDefaultPublicExponent() {
