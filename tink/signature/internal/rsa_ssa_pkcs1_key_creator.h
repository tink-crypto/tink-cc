...
#ifndef TINK_SIGNATURE_INTERNAL_RSA_SSA_PKCS1_KEY_CREATOR_H_
#define TINK_SIGNATURE_INTERNAL_RSA_SSA_PKCS1_KEY_CREATOR_H_
...
// Creates a new RsaSsaPkcs1 private key from `parameters`. If `id_requirement`
...
#endif  // TINK_SIGNATURE_INTERNAL_RSA_SSA_PKCS1_KEY_CREATOR_H_
