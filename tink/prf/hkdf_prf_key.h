...
class HkdfPrfKey : public PrfKey {
 public:
  ...
  HkdfPrfKey& operator=(const HkdfPrfKey& other) = default;
  HkdfPrfKey(HkdfPrfKey&& other) = default;
  ...
  const HkdfPrfParameters& GetParameters() const override {
    return parameters_;
  }
...
#endif  // TINK_PRF_HKDF_PRF_KEY_H_
