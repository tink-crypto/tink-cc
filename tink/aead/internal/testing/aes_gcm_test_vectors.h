...
#ifndef TINK_AEAD_INTERNAL_TESTING_AES_GCM_TEST_VECTORS_H_
#define TINK_AEAD_INTERNAL_TESTING_AES_GCM_TEST_VECTORS_H_
...
#endif  // TINK_AEAD_INTERNAL_TESTING_AES_GCM_TEST_VECTORS_H_
