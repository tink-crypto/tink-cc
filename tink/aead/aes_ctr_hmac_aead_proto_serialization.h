...
#ifndef TINK_AEAD_AES_CTR_HMAC_AEAD_PROTO_SERIALIZATION_H_
#define TINK_AEAD_AES_CTR_HMAC_AEAD_PROTO_SERIALIZATION_H_
...
#endif  // TINK_AEAD_AES_CTR_HMAC_AEAD_PROTO_SERIALIZATION_H_
