...
using AesCtrHmacStreamingProtoSerializationTest = TestWithParam<TestCase>;

TEST_F(AesCtrHmacStreamingProtoSerializationTest,
       RegisterTwiceSucceedsWithMutableRegistry) {
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterAesCtrHmacStreamingProtoSerializationWithMutableRegistry(
                  registry),
              IsOk());
  ASSERT_THAT(RegisterAesCtrHmacStreamingProtoSerializationWithMutableRegistry(
                  registry),
...
TEST_F(AesCtrHmacStreamingProtoSerializationTest,
  ...
  ASSERT_THAT(
      RegisterAesCtrHmacStreamingProtoSerializationWithRegistryBuilder(builder),
      IsOk());
  ASSERT_THAT(
      RegisterAesCtrHmacStreamingProtoSerializationWithRegistryBuilder(builder),
      IsOk());
...
TEST_P(AesCtrHmacStreamingProtoSerializationTest,
...
using AesCtrHmacStreamingParsePrefixTest = TestWithParam<OutputPrefixTypeTP>;

INSTANTIATE_TEST_SUITE_P(
    AesCtrHmacStreamingParsePrefixTestSuite, AesCtrHmacStreamingParsePrefixTest,
...
TEST_P(AesCtrHmacStreamingParsePrefixTest, ParseParametersWithIgnoredPrefix) {
  ...
  HmacParams proto_hmac_params;
  proto_hmac_params.set_tag_size(10);
  proto_hmac_params.set_hash(HashType::SHA1);
  AesCtrHmacStreamingParams proto_params;
  proto_params.set_ciphertext_segment_size(1024);
  proto_params.set_derived_key_size(16);
  proto_params.set_hkdf_hash_type(HashType::SHA1);
  *proto_params.mutable_hmac_params() = proto_hmac_params;
  AesCtrHmacStreamingKeyFormat format;
  format.set_version(0);
  format.set_key_size(19);
  *format.mutable_params() = proto_params;
...
TEST_P(AesCtrHmacStreamingProtoSerializationTest, SerializeParameters) {
  ...
  EXPECT_THAT(format.params().has_hmac_params(), IsTrue());
...
TEST_P(AesCtrHmacStreamingProtoSerializationTest, ParseKeyWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterAesCtrHmacStreamingProtoSerializationWithMutableRegistry(
                  registry),
...
TEST_P(AesCtrHmacStreamingProtoSerializationTest, ParseKeyWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(
      RegisterAesCtrHmacStreamingProtoSerializationWithRegistryBuilder(builder),
...
TEST_P(AesCtrHmacStreamingProtoSerializationTest,
  ...
  EXPECT_THAT(proto_key.params().has_hmac_params(), IsTrue());
