...
class FalconVerifyKeyManager
    : public KeyTypeManager<google::crypto::tink::FalconPublicKey, void,
 ...
 public:
  ...
  absl::Status ValidateKey(
      const google::crypto::tink::FalconPublicKey& key) const override;

 private:
  const std::string key_type_ =
      absl::StrCat(kTypeGoogleapisCom,
                   google::crypto::tink::FalconPublicKey().GetTypeName());
};

}  // namespace tink
}  // namespace crypto

#endif  // TINK_EXPERIMENTAL_PQCRYPTO_SIGNATURE_FALCON_VERIFY_KEY_MANAGER_H_
