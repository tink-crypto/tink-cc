...
#ifndef TINK_JWT_INTERNAL_JWT_ECDSA_KEY_CREATOR_H_
#define TINK_JWT_INTERNAL_JWT_ECDSA_KEY_CREATOR_H_
...
// Generates a new standalone JwtEcdsaPrivateKey from parameters.
//
...
#endif  // TINK_JWT_INTERNAL_JWT_ECDSA_KEY_CREATOR_H_
