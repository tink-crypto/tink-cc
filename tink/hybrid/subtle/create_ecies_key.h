...
#ifndef TINK_HYBRID_SUBTLE_CREATE_ECIES_KEY_H_
#define TINK_HYBRID_SUBTLE_CREATE_ECIES_KEY_H_
...
// Generates a new standalone EciesPrivateKey from parameters.
// Most users should not call this API directly. Instead, most users should
// utilize keysets to ensure key rotation.
absl::StatusOr<EciesPrivateKey> CreateEciesPrivateKey(
...
#endif  // TINK_HYBRID_SUBTLE_CREATE_ECIES_KEY_H_
