...
#ifndef TINK_HYBRID_INTERNAL_ECIES_KEY_CREATOR_H_
#define TINK_HYBRID_INTERNAL_ECIES_KEY_CREATOR_H_
...
// Creates a new EciesPrivateKey from `parameters`.
...
#endif  // TINK_HYBRID_INTERNAL_ECIES_KEY_CREATOR_H_
