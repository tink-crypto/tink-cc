...
using HmacProtoSerializationTest = TestWithParam<TestCase>;

TEST_F(HmacProtoSerializationTest, RegisterTwiceSucceedsWithMutableRegistry) {
...
TEST_F(HmacProtoSerializationTest, RegisterTwiceSucceedsWithRegistryBuilder) {
  // TODO: b/378091229 - Consider disallowing duplicate registrations.
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterHmacProtoSerializationWithRegistryBuilder(builder),
              IsOk());
  ASSERT_THAT(RegisterHmacProtoSerializationWithRegistryBuilder(builder),
              IsOk());
}
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        TestCase{HmacParameters::Variant::kTink, OutputPrefixTypeTP::kTink,
        ...
        TestCase{HmacParameters::Variant::kLegacy, OutputPrefixTypeTP::kLegacy,
...
TEST_P(HmacProtoSerializationTest, ParseParametersWithMutableRegistry) {
...
TEST_P(HmacProtoSerializationTest, ParseParametersWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterHmacProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_P(HmacProtoSerializationTest, SerializeParametersWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterHmacProtoSerializationWithMutableRegistry(registry),
              IsOk());
...
TEST_P(HmacProtoSerializationTest, SerializeParametersWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterHmacProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_P(HmacProtoSerializationTest, ParseKeyWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterHmacProtoSerializationWithMutableRegistry(registry),
              IsOk());
...
TEST_P(HmacProtoSerializationTest, ParseKeyWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterHmacProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_F(HmacProtoSerializationTest, ParseKeyWithUnknownOutputPrefixType) {
  ...
  absl::StatusOr<ProtoKeySerialization> serialization =
      ProtoKeySerialization::Create(
          "type.googleapis.com/google.crypto.tink.HmacKey", serialized_key,
          KeyMaterialTypeTP::kSymmetric, OutputPrefixTypeTP::kUnknownPrefix,
          /*id_requirement=*/0x23456789);
  ASSERT_THAT(serialization, IsOk());
...
TEST_P(HmacProtoSerializationTest, SerializeKeyWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterHmacProtoSerializationWithMutableRegistry(registry),
              IsOk());
...
TEST_P(HmacProtoSerializationTest, SerializeKeyWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterHmacProtoSerializationWithRegistryBuilder(builder),
              IsOk());
