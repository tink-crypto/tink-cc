...
using Ed25519ProtoSerializationTest = TestWithParam<TestCase>;

TEST_F(Ed25519ProtoSerializationTest,
       RegisterTwiceSucceedsWithMutableRegistry) {
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithMutableRegistry(registry),
              IsOk());
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithMutableRegistry(registry),
              IsOk());
}
...
TEST_F(Ed25519ProtoSerializationTest,
  ...
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithRegistryBuilder(builder),
              IsOk());
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithRegistryBuilder(builder),
              IsOk());
}
...
TEST_P(Ed25519ProtoSerializationTest, ParseParametersWithMutableRegistry) {
...
TEST_P(Ed25519ProtoSerializationTest, ParseParametersWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_F(Ed25519ProtoSerializationTest, ParseParametersWithInvalidSerialization) {
  ...
  absl::StatusOr<ProtoParametersSerialization> serialization =
      ProtoParametersSerialization::Create(kPrivateKeyTypeUrl,
...
TEST_F(Ed25519ProtoSerializationTest, ParseParametersWithUnkownOutputPrefix) {
  ...
  absl::StatusOr<ProtoParametersSerialization> serialization =
      ProtoParametersSerialization::Create(
          kPrivateKeyTypeUrl, OutputPrefixTypeTP::kUnknownPrefix,
          key_format_proto.SerializeAsString());
  ASSERT_THAT(serialization, IsOk());
...
TEST_F(Ed25519ProtoSerializationTest, ParseParametersWithInvalidVersion) {
  ...
  absl::StatusOr<ProtoParametersSerialization> serialization =
      ProtoParametersSerialization::Create(
          kPrivateKeyTypeUrl, OutputPrefixTypeTP::kRaw,
          key_format_proto.SerializeAsString());
  ASSERT_THAT(serialization, IsOk());
...
TEST_P(Ed25519ProtoSerializationTest, SerializeParametersWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithMutableRegistry(registry),
              IsOk());
...
TEST_P(Ed25519ProtoSerializationTest, SerializeParametersWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_P(Ed25519ProtoSerializationTest, ParsePublicKeyWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithMutableRegistry(registry),
              IsOk());
  ...
  absl::StatusOr<ProtoKeySerialization> serialization =
      ProtoKeySerialization::Create(
          ...
          serialized_key, KeyMaterialTypeTP::kAsymmetricPublic,
...
TEST_P(Ed25519ProtoSerializationTest, ParsePublicKeyWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_P(Ed25519ProtoSerializationTest, SerializePublicKeyWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithMutableRegistry(registry),
              IsOk());
...
TEST_P(Ed25519ProtoSerializationTest, SerializePublicKeyWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_P(Ed25519ProtoSerializationTest, ParsePrivateKeyWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithMutableRegistry(registry),
              IsOk());
  ...
  *private_key_proto.mutable_public_key() = public_key_proto;
  ...
  absl::StatusOr<ProtoKeySerialization> serialization =
      ProtoKeySerialization::Create(kPrivateKeyTypeUrl, serialized_key,
...
TEST_P(Ed25519ProtoSerializationTest, ParsePrivateKeyWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_P(Ed25519ProtoSerializationTest, SerializePrivateKeyWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithMutableRegistry(registry),
              IsOk());
...
TEST_P(Ed25519ProtoSerializationTest, SerializePrivateKeyWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterEd25519ProtoSerializationWithRegistryBuilder(builder),
              IsOk());
