...
TEST(CreateRsaSsaPssKeyTest, CreateRsaSsaPssPrivateKeyWorks) {
  ...
  absl::StatusOr<RsaSsaPssPrivateKey> private_key =
      CreateRsaSsaPssPrivateKey(*parameters, /*id_requirement=*/123);
  ASSERT_THAT(private_key, IsOk());
  EXPECT_THAT(private_key->GetIdRequirement(), Eq(123));
  EXPECT_THAT(private_key->GetParameters(), Eq(*parameters));
}

TEST(CreateRsaSsaPssKeyTest, CreateRsaSsaPssPrivateKeyWithoutIdRequirement) {
  absl::StatusOr<RsaSsaPssParameters> parameters =
      RsaSsaPssParameters::Builder()
          .SetModulusSizeInBits(2048)
          .SetSigHashType(RsaSsaPssParameters::HashType::kSha256)
  ...
  absl::StatusOr<RsaSsaPssPrivateKey> private_key =
      CreateRsaSsaPssPrivateKey(*parameters);
  ASSERT_THAT(private_key, IsOk());
  EXPECT_THAT(private_key->GetIdRequirement().has_value(), IsFalse());
  EXPECT_THAT(private_key->GetParameters(), Eq(*parameters));
}

TEST(CreateRsaSsaPssKeyTest,
     CreateRsaSsaPssPrivateKeyMissingIdRequirementForTinkFails) {
  absl::StatusOr<RsaSsaPssParameters> parameters =
      RsaSsaPssParameters::Builder()
          .SetModulusSizeInBits(2048)
          .SetSigHashType(RsaSsaPssParameters::HashType::kSha256)
  ...
  EXPECT_THAT(CreateRsaSsaPssPrivateKey(*parameters),
              StatusIs(absl::StatusCode::kInvalidArgument));
}

TEST(CreateRsaSsaPssKeyTest,
     CreateRsaSsaPssPrivateKeyIdRequirementGivenForNoPrefixFails) {
  absl::StatusOr<RsaSsaPssParameters> parameters =
      RsaSsaPssParameters::Builder()
          .SetModulusSizeInBits(2048)
          .SetSigHashType(RsaSsaPssParameters::HashType::kSha256)
  ...
  EXPECT_THAT(CreateRsaSsaPssPrivateKey(*parameters, /*id_requirement=*/123),
              StatusIs(absl::StatusCode::kInvalidArgument));
}

TEST(CreateRsaSsaPssKeyTest,
     CreateRsaSsaPssPrivateKeySuccessiveKeysAreDistinct) {
  absl::StatusOr<RsaSsaPssParameters> parameters =
      RsaSsaPssParameters::Builder()
          .SetModulusSizeInBits(2048)
          .SetSigHashType(RsaSsaPssParameters::HashType::kSha256)
  ...
  absl::StatusOr<RsaSsaPssPrivateKey> key1 =
      CreateRsaSsaPssPrivateKey(*parameters, /*id_requirement=*/123);
  ASSERT_THAT(key1, IsOk());

  absl::StatusOr<RsaSsaPssPrivateKey> key2 =
      CreateRsaSsaPssPrivateKey(*parameters, /*id_requirement=*/123);
