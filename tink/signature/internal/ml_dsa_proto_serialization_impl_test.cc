...
using MlDsaProtoSerializationTest = TestWithParam<TestCase>;
...
MlDsaPrivateKey GenerateMlDsaPrivateKey(MlDsaParameters::Instance instance,
  ...
  absl::StatusOr<std::unique_ptr<MlDsaPrivateKey>> private_key =
      CreateMlDsaKey(*parameters, id_requirement);
...
TEST_F(MlDsaProtoSerializationTest, RegisterTwiceSucceedsWithMutableRegistry) {
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithMutableRegistry(registry),
              IsOk());
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithMutableRegistry(registry),
              IsOk());
}

TEST_F(MlDsaProtoSerializationTest, RegisterTwiceSucceedsWithRegistryBuilder) {
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithRegistryBuilder(builder),
              IsOk());
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithRegistryBuilder(builder),
              IsOk());
}

TEST_P(MlDsaProtoSerializationTest, ParseParametersWorksWithMutableRegistry) {
...
TEST_P(MlDsaProtoSerializationTest, ParseParametersWorksWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_P(MlDsaProtoSerializationTest, ParsePublicKeyWorksWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithMutableRegistry(registry),
              IsOk());
...
TEST_P(MlDsaProtoSerializationTest, ParsePublicKeyWorksWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_P(MlDsaProtoSerializationTest, ParsePrivateKeyWorksWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithMutableRegistry(registry),
              IsOk());
...
TEST_P(MlDsaProtoSerializationTest, ParsePrivateKeyWorksWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_P(MlDsaProtoSerializationTest, SerializePrivateKeyWithMutableRegistry) {
  TestCase test_case = GetParam();
  MutableSerializationRegistry registry;
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithMutableRegistry(registry),
              IsOk());
...
TEST_P(MlDsaProtoSerializationTest, SerializePrivateKeyWithRegistryBuilder) {
  TestCase test_case = GetParam();
  SerializationRegistry::Builder builder;
  ASSERT_THAT(RegisterMlDsaProtoSerializationWithRegistryBuilder(builder),
              IsOk());
...
TEST_F(MlDsaProtoSerializationTest, ParseGoldenPrivateKey65Works) {
  ...
  absl::StatusOr<ProtoKeySerialization> serialization =
      ProtoKeySerialization::Create(kPrivateTypeUrl, serialized_key,
                                    KeyMaterialTypeTP::kAsymmetricPrivate,
                                    OutputPrefixTypeTP::kTink, 0x03050709);
  ASSERT_THAT(serialization, IsOk());
