...
TEST(JwtEcdsaKeyCreatorTest, CreateJwtEcdsaPrivateKeyWorksBase64EncodedKeyId) {
  ...
  EXPECT_THAT(key->GetPublicKey().GetKid(), Eq("AAAAew"));
}

TEST(JwtEcdsaKeyCreatorTest, CreateJwtEcdsaPrivateKeyWorksIgnored) {
  ...
  EXPECT_THAT(key->GetPublicKey().GetKid().has_value(), IsFalse());
}

TEST(JwtEcdsaKeyCreatorTest, CreateJwtEcdsaPrivateKeyWorksCustomKid) {
  absl::StatusOr<JwtEcdsaParameters> parameters =
...
TEST(JwtEcdsaKeyCreatorTest, MissingIdRequirementForBase64KeyIdFails) {
  absl::StatusOr<JwtEcdsaParameters> parameters = JwtEcdsaParameters::Create(
      JwtEcdsaParameters::KidStrategy::kBase64EncodedKeyId,
      JwtEcdsaParameters::Algorithm::kEs256);
  ASSERT_THAT(parameters, IsOk());
...
TEST(JwtEcdsaKeyCreatorTest, MissingCustomKidForCustomKidStrategyFails) {
  absl::StatusOr<JwtEcdsaParameters> parameters =
      JwtEcdsaParameters::Create(JwtEcdsaParameters::KidStrategy::kCustom,
                                 JwtEcdsaParameters::Algorithm::kEs256);
  ASSERT_THAT(parameters, IsOk());
...
TEST(JwtEcdsaKeyCreatorTest, UnexpectedIdRequirementForIgnoredFails) {
  absl::StatusOr<JwtEcdsaParameters> parameters =
      JwtEcdsaParameters::Create(JwtEcdsaParameters::KidStrategy::kIgnored,
                                 JwtEcdsaParameters::Algorithm::kEs256);
  ASSERT_THAT(parameters, IsOk());

  EXPECT_THAT(CreateJwtEcdsaPrivateKey(*parameters, /*id_requirement=*/123),
              StatusIs(absl::StatusCode::kInvalidArgument));
}

TEST(JwtEcdsaKeyCreatorTest, UnexpectedIdRequirementForCustomKidFails) {
  absl::StatusOr<JwtEcdsaParameters> parameters =
      JwtEcdsaParameters::Create(JwtEcdsaParameters::KidStrategy::kCustom,
                                 JwtEcdsaParameters::Algorithm::kEs256);
  ASSERT_THAT(parameters, IsOk());
...
TEST(JwtEcdsaKeyCreatorTest, UnexpectedCustomKidForBase64KeyIdFails) {
  absl::StatusOr<JwtEcdsaParameters> parameters = JwtEcdsaParameters::Create(
      JwtEcdsaParameters::KidStrategy::kBase64EncodedKeyId,
      JwtEcdsaParameters::Algorithm::kEs256);
  ASSERT_THAT(parameters, IsOk());
...
TEST(JwtEcdsaKeyCreatorTest, UnexpectedCustomKidForIgnoredFails) {
  absl::StatusOr<JwtEcdsaParameters> parameters =
      JwtEcdsaParameters::Create(JwtEcdsaParameters::KidStrategy::kIgnored,
                                 JwtEcdsaParameters::Algorithm::kEs256);
  ASSERT_THAT(parameters, IsOk());
...
TEST(JwtEcdsaKeyCreatorTest, SuccessiveKeysAreDistinct) {
  absl::StatusOr<JwtEcdsaParameters> parameters = JwtEcdsaParameters::Create(
      JwtEcdsaParameters::KidStrategy::kBase64EncodedKeyId,
      JwtEcdsaParameters::Algorithm::kEs256);
  ASSERT_THAT(parameters, IsOk());
  ...
  EXPECT_THAT(key1->GetPublicKey().GetPublicPoint(GetPartialKeyAccess()),
              Ne(key2->GetPublicKey().GetPublicPoint(GetPartialKeyAccess())));
}
