...
#ifndef TINK_AEAD_INTERNAL_LEGACY_KMS_AEAD_PROTO_SERIALIZATION_IMPL_H_
#define TINK_AEAD_INTERNAL_LEGACY_KMS_AEAD_PROTO_SERIALIZATION_IMPL_H_
...
#endif  // TINK_AEAD_INTERNAL_LEGACY_KMS_AEAD_PROTO_SERIALIZATION_IMPL_H_
