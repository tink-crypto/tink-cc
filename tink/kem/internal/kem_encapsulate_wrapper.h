...
#ifndef TINK_KEM_INTERNAL_KEM_ENCAPSULATE_WRAPPER_H_
#define TINK_KEM_INTERNAL_KEM_ENCAPSULATE_WRAPPER_H_
...
#endif  // TINK_KEM_INTERNAL_KEM_ENCAPSULATE_WRAPPER_H_
