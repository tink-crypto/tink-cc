...
TEST(SlhDsaVerifyBoringSslTest, TestVectorSignVerify) {
  constexpr absl::string_view kHexPrivateKey =
      "d44f6f06a73a07451096ad4bfbd240cb54b779330a65ed34ec0cd372c96fe48bf2b907c6"
  ...
  constexpr absl::string_view kHexMessage = "6d657373616765";
  constexpr absl::string_view kHexSignature =
      "677020005c0922919fb6b837c42783b93a71a10db1794c86683f5f22dd1f0b984a66f749"
      ...
      "6c60f23dfd1cc4c9";
  std::string private_bytes = test::HexDecodeOrDie(kHexPrivateKey);
  std::string public_key_bytes = test::HexDecodeOrDie(kHexPublicKey);
  std::string message_bytes = test::HexDecodeOrDie(kHexMessage);
  std::string signature_bytes = test::HexDecodeOrDie(kHexSignature);
