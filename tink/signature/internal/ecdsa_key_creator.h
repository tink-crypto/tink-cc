...
#ifndef TINK_SIGNATURE_INTERNAL_ECDSA_KEY_CREATOR_H_
#define TINK_SIGNATURE_INTERNAL_ECDSA_KEY_CREATOR_H_
...
#endif  // TINK_SIGNATURE_INTERNAL_ECDSA_KEY_CREATOR_H_
